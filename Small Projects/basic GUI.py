...
class ParentWindow(Frame):
    def __init__ (self, master):
        ...
        self.lblLName.grid(row=1, column=0, padx=(30,0), pady=(15,0))
        ...
        self.txtLName.grid(row=1, column=1, padx=(10,0), pady=(15,0))

        self.btnSubmit = Button(self.master, text="Submit", width=10, height=2, command=self.submit)
        self.btnSubmit.grid(row=2, column=1, padx=(0,0), pady=(15, 0), sticky=NE)

        self.btnCancel = Button(self.master, text="Cancel", width=10, height=2, command=self.cancel)
        self.btnCancel.grid(row=2, column=1, padx=(0,90), pady=(15, 0), sticky=NE)
